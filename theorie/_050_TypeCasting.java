...
public class _050_TypeCasting {
	...
	// Kleiner Wert in gr��eren Container ist erlaubt
	byte b1 = 100;
	int int1 = b1;
	// int int1 = (int)b1;  // Funktioniert, ist aber nicht n�tig
	System.out.println(int1);  // 100
	
	// Gr��erer Datentyp geht nicht in einen kleineren Container
	// int int2 = 42;
	// byte b2;
	...
	// Bei zu gro�en Werten gibt es einen �berlauf
	int int4 = 128;
	byte b4 = (byte)int4;
	...
	int int6 = 78;
	double dou6 = int6;
	// double dou6 = (double)int6;  // Funktioniert, ist aber nicht n�tig
