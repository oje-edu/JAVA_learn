package kapitel_10.Aufgabe_104_7;
...
public class ContactlistWithSplit extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					ContactlistWithSplit frame = new ContactlistWithSplit();
	...
	public ContactlistWithSplit() {
		...
		lblLastname.setBounds(10, 11, 105, 14);
		cPane.add(lblLastname);

		tfLastname = new JTextField();
		tfLastname.setBounds(10, 27, 131, 20);
		cPane.add(tfLastname);
		tfLastname.setColumns(10);

		JLabel lblFirstname = new JLabel("Vorname");
		lblFirstname.setBounds(154, 11, 87, 14);
		cPane.add(lblFirstname);

		tfFirstname = new JTextField();
		tfFirstname.setBounds(155, 27, 131, 20);
