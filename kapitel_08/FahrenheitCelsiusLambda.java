...
public class FahrenheitCelsiusLambda extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					FahrenheitCelsiusLambda frame = new FahrenheitCelsiusLambda();
	 ...
	 * Create the frame.
	 */
	public FahrenheitCelsiusLambda() {
		setTitle("Umrechnung Fahrenheit Celsius mit Lambda-Ausdruck");
		setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
		setBounds(100, 100, 477, 158);
