...
// source https://www.reddit.com/r/java/comments/p38yqq/java_threads_and_the_mandelbrot_set/
//
// NETFLIX: THE COLOURS OF INFINITY
...
public class Mandelbrot {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(() -> {
			...
			frame = new JFrame("The Mandelbrot Set (w/Mouse Zoom)");
			frame.add(label);
			frame.pack();
	...
	private static void printThreadInfo() {
		...
		Arrays.stream(Thread.currentThread().getStackTrace()).skip(2).limit(4).forEach(System.out::println);
		System.out.println();
	}
